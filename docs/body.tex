...
functions of Observatory Operations and generates prompt data products (L1)\footnote{Prompt products were previously referred to as Level 1 products and in this document Level 1 is often used in this context.}
...
\subsection{Telemetry Gateway Service}
\input{docs/L1_Services/Telemetry_Gateway_Service}
...
\subsection{Bulk Data Export Service}
